...
class TestExtractFilters:
    def test_extract_filters_no_list_filter(self, MockUser):
        ...
        result = AdminSite._extract_filters(MockUser, {"name": "alice"})

        assert result is None

    def test_extract_filters_empty_params(self, MockUser):
        result = AdminSite._extract_filters(MockUser, {}, list_filter=["name"])

        assert result is None

    def test_extract_filters_fk_int(self, MockPost):
        result = AdminSite._extract_filters(
    ...
    def test_extract_filters_int(self, MockUser):
        result = AdminSite._extract_filters(MockUser, {"id": "10"}, list_filter=["id"])
    ...
    def test_extract_filters_int_invalid(self, MockUser):
        ...
        result = AdminSite._extract_filters(MockUser, {"id": "abc"}, list_filter=["id"])
